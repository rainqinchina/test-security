...
public class AES {
    ...
    public static String sKey = DigestUtils.md5DigestAsHex("1234567890ABDCEF".getBytes()).substring(16);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String str = AES.encrypt("{\"order_no\":\"110000\",\"password\":\"1\"}");
            
//            System.out.println("md5 " + DigestUtils.md5DigestAsHex(sKey.getBytes()).length());
            System.out.println(str);
            String str1 = AES.decrypt(str);
